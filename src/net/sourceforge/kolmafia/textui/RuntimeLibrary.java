...
public abstract class RuntimeLibrary {
  ...
  private static final RecordType purchaseRequestRec =
      new RecordType(
          ...
          new String[] {"item", "quantity", "price", "limit", "shopName"},
          new Type[] {
            DataTypes.ITEM_TYPE,
            DataTypes.INT_TYPE,
            DataTypes.INT_TYPE,
  ...
  static {
    ...
    params = new Type[] {};
    functions.add(new LibraryFunction("should_current_thread_continue", DataTypes.BOOLEAN_TYPE, params));
  ...
  public static Value search_mall(ScriptRuntime controller, final Value item, final Value count) {
    ...
    for (int i = 0, searchResultsSize = searchResults.size(); i < searchResultsSize; i++) {
      ...
      result.aset(4, DataTypes.makeStringValue(searchResult.getShopName()), null);
