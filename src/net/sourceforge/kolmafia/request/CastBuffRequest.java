...
public class CastBuffRequest extends GenericRequest {
  ...
  private CastBuffRequest(final int skillId, final String targetPlayerId, int buffCount) {
    ...
    this.addFormField("targetplayer", targetPlayerId);
  ...
  public static CastBuffRequest getInstance(int skillId, String targetPlayerId, int buffCount) {
    return new CastBuffRequest(skillId, targetPlayerId, buffCount);
  }
