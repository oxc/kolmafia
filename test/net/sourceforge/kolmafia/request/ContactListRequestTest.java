...
class ContactListRequestTest {
  ...
  class IgnoreList {
    ...
    void canParseNonEmptyIgnoreList() {
      ...
      assertThat(ContactManager.getIgnoredPlayers(), aMapWithSize(1));
      assertThat(ContactManager.getIgnoredPlayers(), hasEntry("1", "Jick"));
      assertThat(ContactManager.isIgnoredPlayer("1"), equalTo(true));
      ...
      assertThat(ContactManager.isIgnoredPlayer(ContactManager.getPlayerId("jick")), equalTo(true));
    }
    ...
    void canParseEmptyIgnoreList() {
      ...
      assertThat(ContactManager.getIgnoredPlayers(), anEmptyMap());
      assertThat(ContactManager.isIgnoredPlayer("1"), equalTo(false));
    }
    ...
    void doesNotConfuseTheTwoLists() {
      ...
      assertThat(ContactManager.isIgnoredPlayer("3495347"), equalTo(false));
      assertThat(
          ContactManager.isIgnoredPlayer(ContactManager.getPlayerId("TortureBot")), equalTo(false));
    }
